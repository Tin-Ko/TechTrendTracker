...
class Extractor:
    ...
    def extract_skills_from_job(self, description):
        ...
        system_prompt = """
            The user will provide a job description for a position. Please extract only the required software skills such as programming languages, software frameworks, or any certifications for the provided job position.
            ...
            EXAMPLE JSON OUTPUT:
            {
                "tech_skills": ["Python", "JavaScript", "SolidJS"]
            }
...
if __name__ == "__main__":
    ...
    extractor = Extractor(api_key=LLM_API_KEY, base_url="https://api.deepseek.com")
